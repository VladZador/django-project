...
CELERY_RESULT_BACKEND = "django_celery_results.backends.database.DatabaseBackend"  # noqa E501
...
try:
    from mystore.settings_local import *  # noqa F401, F403
except ImportError:
    print("Not allowed")
